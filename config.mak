...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--cross-prefix=unicore32-linux- --enable-cross-compile --target-os=linux --cc=unicore32-linux-gcc --arch=unicore32 --prefix=/usr/local/ffmpeg124x264uni --enable-shared --disable-static --enable-gpl --enable-nonfree --enable-ffmpeg --disable-ffplay --enable-ffserver --enable-swscale --enable-pthreads --disable-armv5te --disable-armv6 --disable-armv6t2 --disable-yasm --disable-stripping --extra-cflags=-I/usr/local/ffmpeg124x264uni/include --extra-ldflags=-L/usr/local/ffmpeg124x264uni/lib/
...
CC_IDENT=gcc 4.4.2 (UC4_1.0-beta_20100415)
ARCH=unicore32
CC=unicore32-linux-gcc
CXX=unicore32-linux-g++
AS=unicore32-linux-gcc
LD=unicore32-linux-gcc
DEPCC=unicore32-linux-gcc
DEPCCFLAGS= $(CPPFLAGS)
DEPAS=unicore32-linux-gcc
DEPASFLAGS= $(CPPFLAGS)
YASM=yasm
DEPYASM=yasm
...
LD_PATH=-L
DLLTOOL=
LDFLAGS= -L/usr/local/ffmpeg124x264uni/lib/  -Wl,--as-needed -Wl,--warn-common -Wl,-rpath-link=libpostproc:libswresample:libswscale:libavfilter:libavdevice:libavformat:libavcodec:libavutil:libavresample
