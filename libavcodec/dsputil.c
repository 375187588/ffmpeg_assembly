...
extern int my_pix_sum_c(uint8_t * pix, int line_size);
extern int my_test_pix_sum_c(uint8_t * pix, int line_size);
extern int st_my_test_pix_sum_c(uint8_t * pix, int line_size);
