...
static inline int my_ff_mpeg4_pred_dc(MpegEncContext * s, int n, int level)
{
                        ...
                        int motion_x, int motion_y)
{
    ...
    PutBitContext * const pb2    = &s->pb;
    PutBitContext * const tex_pb = &s->pb;
    PutBitContext * const dc_pb  = &s->pb;
        ...
        for(i=0; i<6; i++){
            ...
            dc_diff[i]= my_ff_mpeg4_pred_dc(s, i, block[i][0]);
        }
